...
## Description
Goal of push swap project is to sort random numbers into ascending order using specific movements with two stacks.
...
```bash
make
./push_swap "intput numbers"
ARG="input numbers"; ./push_swap $ARG | ./checker_linux $ARG
```
---
